from method import (training_camouflage, dataset_cleaning,
                    ...
                    track4, track5, track6, track7, test_camera_position, test_camera_position,
...
if __name__ == "__main__":
    ...
    # track_result()
    # evaluate_tracking_results("./output/camo_metrics/no_carla7/true_bbox", "./output/camo_metrics/no_carla7/ori_bbox")
